...
/*Если поставить точку в конце команды "npx create-react-app my-app .", то проект будет создан в папке, в которой
мы находимся.*/

/*"npm i prettier --save-dev" - команда для установки prettier, чтобы он автоматически форматировал код при
сохранении. Здесь не используется.*/
